...
resource "aws_subnet" "private_1a" {
  ...
  # Removed availability_zone_id conflict
  # Removed enable_lni_at_device_index = 0 (invalid)
  # Removed map_customer_owned_ip_on_launch (requires Outpost)
...
# VPC - Fixed IPv6 configuration conflicts
resource "aws_vpc" "main" {
  cidr_block           = "10.0.0.0/16"
  enable_dns_hostnames = true
  enable_dns_support   = true
  # Removed ipv6_netmask_length = 0 (conflicts with ipv6_ipam_pool_id)
...
# VPC Endpoint - Simplified configuration
